...
\includegraphics[width=\linewidth]{stanford_logos/SUSig_Seal_Stacked_Left.eps} % University logo
\end{minipage}
\hfill
\begin{minipage}[t]{0.6\textwidth}
\vspace{0pt} % Ensures that the top of the text aligns with the top of the image
{\color{gray}\LARGE Departments of Science 1 and Science 2\color{black}\small\newline 300 E Campus Drive \mybullet Stanford, CA, 94025 \mybullet USA}
